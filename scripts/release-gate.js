...
const checks = [
  ...
  { name: 'safe-remote-fetch', cmd: process.execPath, args: ['tests/test-safe-remote-fetch.js'] },
  { name: 'oauth-session-hardening', cmd: process.execPath, args: ['tests/test-oauth-session-hardening.js'] },
  { name: 'csrf-protection', cmd: process.execPath, args: ['tests/test-csrf-protection.js'] },
  ...
  { name: 'battle-stats-tenant-scope', cmd: process.execPath, args: ['tests/test-battle-stats-tenant-scope.js'] },
  ...
  { name: 'webhook-durable-inbox', cmd: process.execPath, args: ['tests/test-webhook-durable-inbox.js'] },
