...
const checks = [
  ...
  { name: 'session-fixation', cmd: process.execPath, args: ['tests/test-session-fixation.js'] },
  { name: 'verify-challenge-binding', cmd: process.execPath, args: ['tests/test-verify-challenge-binding.js'] },
  { name: 'return-origin', cmd: process.execPath, args: ['tests/test-return-origin.js'] },
  { name: 'csrf', cmd: process.execPath, args: ['tests/test-csrf.js'] },
