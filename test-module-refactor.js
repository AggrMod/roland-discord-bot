...
const togglesPath = path.join(__dirname, 'config/module-toggles.json');
...
const moduleGuardPath = path.join(__dirname, 'utils/moduleGuard.js');
...
const docsPath = path.join(__dirname, 'docs/COMMAND_ARCHITECTURE.md');
